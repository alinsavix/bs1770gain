...
void lib1770_biquad_get_ps(lib1770_biquad_t *biquad, lib1770_biquad_ps_t *ps)
{
...
lib1770_biquad_t *lib1770_biquad_requantize(lib1770_biquad_t *out,
    lib1770_biquad_t *in)
{
  if (in->samplerate==out->samplerate)
    *out=*in;
    ...
    out->b0=LIB1770_DEN((ps.vh+ps.vb*k_by_q+ps.vl*k_sq)/a0);
    out->b1=LIB1770_DEN((2.0*(ps.vl*k_sq-ps.vh))/a0);
    out->b2=LIB1770_DEN((ps.vh-ps.vb*k_by_q+ps.vl*k_sq)/a0);
  }
